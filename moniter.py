...
def cpu_probe(data_dict):
    ...
    data_dict["interrupt_time"] = cpu_t.softirq #In Linux there is no property mentioned as 'interrupt' since used softirq
...
if __name__ == "__main__":
    ...
    while True:
        ...
        print(monit_data)
        sleep(1)
        write_dict_to_csv("normal_annomaly_dataset2.csv", monit_data, is_first_time)
        is_first_time = False
